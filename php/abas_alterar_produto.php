...
<html lang="PT-BR">
	...
	<body>
        <?php
            include("conexao.php");
            $cod = $_GET['id'];
            $result_produto = "SELECT * FROM produtos WHERE idprodutos=".$cod;
            $resultado_produto = mysqli_query($conexao, $result_produto);
			$instrucao = mysqli_query($conexao, $result_produto);
            if ($instrucao){
                $rows_produtos = mysqli_fetch_array($resultado_produto);
            }else {
						...
						<div class="separacao" style="border:2px solid transparent;" >
							...
							<div class="linha">
								<div class="campo-entrada-diverso" style="width: 20%;">
									...
									<input type="number" value="<?=$rows_produtos['idprodutos']; ?>" name="cod_interno_pro" id="txt_cod_interno_pro" required style="height: 25px;">
								</div>
								<div class="campo-entrada">
									<label for="cod_barras_pro">Código de barras</label>
									<input type="text" value="<?=$rows_produtos['cod_barras']; ?>" name="cod_barras_pro" id="txt_cod_barras_pro" maxlength="15" required style="height: 25px;">
								</div>
								<div class="campo-entrada-diverso" style="width: 10%;">
									<label for="unidade_pro">Unidade</label>
									<input type="text" value="<?=$rows_produtos['unidade']; ?>" name="unidade_pro" id="txt_unidade_pro" maxlength="9" required style="height: 25px;">
								</div>
							</div>
							<div class="linha">
								<div class="campo-entrada-diverso" style="width: 20%;">
									<label for="quantidade_pro">Quantidade</label>
									<input type="text" value="<?=$rows_produtos['quant']; ?>" name="quantidade_pro" id="txt_quantidade_pro" required style="height: 25px;">
								</div>
								<div class="campo-entrada">
									<label for="descricao_pro">Descrição</label>
									<input type="text" value="<?=$rows_produtos['descricao']; ?>" name="descricao_pro" id="txt_descricao_pro" required style="height: 25px;">
								</div>
							</div>
							<div class="linha">
								<div class="campo-entrada-diverso">
							...
							<div class="linha">
								<div class="campo-entrada-diverso" style="width: 70%;">
									...
									<input type="text" value="<?=$rows_produtos['rua']; ?>" name="rua_pro" id="txt_rua_pro" style="height: 25px;">
								</div>
								<div class="campo-entrada-diverso" style="width: 10%;">
									<label for="numero_pro">Número</label>
									<input type="text" value="<?=$rows_produtos['num']; ?>" name="numero_pro" id="txt_numero_pro" maxlength="4" style="height: 25px;">
								</div>
								<div class="campo-entrada">
									<label for="complemento_pro">Complemento</label>
									<input type="text" value="<?=$rows_produtos['complemento']; ?>" name="complemento_pro" id="txt_complemento_pro" style="height: 25px;">
								</div>
							</div>
							<div class="linha">
								<div class="campo-entrada-diverso" style="width: 12.5%;">
									<label for="telefone_pro">Telefone</label>
									<input type="text" value="<?=$rows_produtos['tel']; ?>" name="telefone_pro" id="txt_telefone_pro" maxlength="8" style="height: 25px;">
								</div>
								<div class="campo-entrada-diverso" style="width: 15%;">
									<label for="celular_pro">Celular</label>
									<input type="text" value="<?=$rows_produtos['cel']; ?>" name="celular_pro" id="txt_celular_pro" maxlength="11" style="height: 25px;">
								</div>
								<div class="campo-entrada">
									<label for="email_pro">E-mail</label>
									<input type="email" value="<?=$rows_produtos['email']; ?>" name="email_pro" id="txt_email_pro" style="height: 25px;">
								</div>
							</div>
							<div class="linha" >
								<div class="linha">
									<fieldset  class="campo-entrada-fieldset">
										...
										<div class="campo-entrada-fieldset">
											...
											<input type="text" value="<?=$rows_produtos['preco_entrada']; ?>" name="entrada_pro" id="txt_entrada_pro" required style="height: 25px;">
										</div>
										<div class="campo-entrada-fieldset">
											<label for="custo_pro">Custo</label>
											<input type="text" value="<?=$rows_produtos['preco_custo']; ?>" name="custo_pro" id="txt_custo_pro" required style="height: 25px;">
										</div>
										<div class="campo-entrada-fieldset">
											<label for="lucro_pro">Lucro</label>
											<input type="text" value="<?=$rows_produtos['lucro']; ?>" name="lucro_pro" id="lucro_pro" style="height: 25px;">
										</div>
									</fieldset>
								</div>
								<div class="linha">
									<fieldset class="campo-entrada-fieldset">
										...
										<div class="campo-entrada-fieldset">
											...
											<input type="text" value="<?=$rows_produtos['min']; ?>" name="min_pro" id="txt_min_pro" required style="height: 25px;">
										</div>
										<div class="campo-entrada-fieldset">
											<label for="max_pro">Max</label>
											<input type="text" value="<?=$rows_produtos['max']; ?>" name="max_pro" id="txt_max_pro" required style="height: 25px;">
										</div>
									</fieldset>
								</div>
							</div>
